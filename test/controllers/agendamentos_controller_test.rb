...
class AgendamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agendamento" do
    assert_difference("Agendamento.count") do
      post agendamentos_url, params: { agendamento: { data_hora: @agendamento.data_hora, observacoes: @agendamento.observacoes, pet_id: @agendamento.pet_id, veterinario_id: @agendamento.veterinario_id } }
    end
  ...
  test "should update agendamento" do
    patch agendamento_url(@agendamento), params: { agendamento: { data_hora: @agendamento.data_hora, observacoes: @agendamento.observacoes, pet_id: @agendamento.pet_id, veterinario_id: @agendamento.veterinario_id } }
